...
t_data *init_builtin_cmd_redir_in(t_data *data)
{
	...
	data->line = strdup("< file_in_1.txt pwd");
	data->cmd_node = cmd_node;
	data->pwd = NULL;
	data->old_pwd = NULL;
	data->env_list = NULL;
...
t_data *init_builtin_cmd_multi_redir_in(t_data *data)
{
	...
	if (!data || !cmd_node || !cmd || !file1 || !file2)
		return (NULL);
	...
	data->line = strdup("< file_in_1 < file_in_2 pwd");
	data->cmd_node = cmd_node;
	data->pwd = NULL;
	data->old_pwd = NULL;
	data->env_list = NULL;
...
t_data *init_builtin_cmd_multi_redir_in_heredoc(t_data *data)
{
	...
	data->line = strdup("< file_in_1 < file_in_2 << EOF pwd");
	data->cmd_node = cmd_node;
	data->pwd = NULL;
	data->old_pwd = NULL;
	data->env_list = NULL;
...
t_data *init_builtin_cmd_multi_redir_in_multi_heredoc(t_data *data)
{
	...
	data->line = strdup("< file_in_1 < file_in_2 << EOF1 << EOF2 pwd");
	data->cmd_node = cmd_node;
	data->pwd = NULL;
	data->old_pwd = NULL;
	data->env_list = NULL;
